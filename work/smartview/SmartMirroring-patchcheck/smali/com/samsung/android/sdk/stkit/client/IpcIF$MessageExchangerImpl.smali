...
.super Lcom/samsung/android/service/stplatform/communicator/g;
.source "SourceFile"
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/function/Function;)V
    ...
    invoke-direct {p0}, Lcom/samsung/android/service/stplatform/communicator/g;-><init>()V
...
.method public static synthetic a(Lcom/samsung/android/service/stplatform/communicator/Response;Lcom/samsung/android/sdk/stkit/client/IpcIF$ResponseReceivedListener;)V
    .locals 0
...
.method public handleResponse(Lcom/samsung/android/service/stplatform/communicator/Response;)V
    ...
    iget v1, p1, Lcom/samsung/android/service/stplatform/communicator/Response;->h:I
    ...
    iget v1, p1, Lcom/samsung/android/service/stplatform/communicator/Response;->i:I
    ...
    check-cast v0, Lcom/samsung/android/sdk/stkit/client/IpcIF$ResponseReceivedListener;
...
.method public pickAndSendRequest()V
    ...
    check-cast v0, Lcom/samsung/android/sdk/stkit/client/IpcRequest;
    ...
    invoke-virtual {v0}, Lcom/samsung/android/sdk/stkit/client/IpcRequest;->getRequestCode()I

    move-result v2

    invoke-virtual {v0}, Lcom/samsung/android/sdk/stkit/client/IpcRequest;->getRequestSubCode()I

    move-result v3

    invoke-virtual {v0}, Lcom/samsung/android/sdk/stkit/client/IpcRequest;->getExtra()Landroid/os/Bundle;

    move-result-object v0

    invoke-direct {v1, v2, v3, v0}, Lcom/samsung/android/service/stplatform/communicator/Request;-><init>(IILandroid/os/Bundle;)V

    invoke-virtual {p0, v1}, Lcom/samsung/android/service/stplatform/communicator/g;->sendRequest(Lcom/samsung/android/service/stplatform/communicator/Request;)V
