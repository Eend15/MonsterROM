...
.field public S:Landroidx/appcompat/widget/i1;

.field public T:Landroidx/appcompat/widget/z;

.field public U:Landroidx/appcompat/widget/h1;
...
.field public final d0:Landroid/view/animation/PathInterpolator;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Landroidx/appcompat/widget/f1;-><init>(Ljava/lang/Class;Ljava/lang/String;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/content/res/ColorStateList;

    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Z

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    invoke-static {}, Landroid/view/VelocityTracker;->obtain()Landroid/view/VelocityTracker;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->E:Landroid/view/VelocityTracker;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->V:Landroid/graphics/Rect;

    iput v13, v7, Landroidx/appcompat/widget/SwitchCompat;->e0:I

    invoke-virtual/range {p0 .. p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v7, v0}, Landroidx/appcompat/widget/j1;->a(Landroid/view/View;Landroid/content/Context;)V

    new-instance v14, Landroid/text/TextPaint;

    invoke-direct {v14, v10}, Landroid/text/TextPaint;-><init>(I)V

    iput-object v14, v7, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/text/TextPaint;
    ...
    invoke-direct {v15, v8, v6}, LA/c;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {v15, v0}, LA/c;->m(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v15, v1}, LA/c;->m(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->m:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/drawable/Drawable;

    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;

    :goto_1
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->r:I
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->s:I
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->t:I
    ...
    invoke-virtual {v15, v2}, LA/c;->l(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v12}, Landroidx/appcompat/widget/g0;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iget-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, v2, :cond_5

    iput-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Z

    :cond_5
    iget-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Z

    if-nez v2, :cond_6

    iget-boolean v2, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Z
    ...
    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Z
    ...
    invoke-static {v4, v12}, Landroidx/appcompat/widget/g0;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iget-object v5, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;

    if-eq v5, v4, :cond_9

    iput-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v10, v7, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    :cond_9
    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Z

    if-nez v4, :cond_a

    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->q:Z
    ...
    invoke-static {v8, v6}, Lr2/a;->w(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v7, Landroidx/appcompat/widget/SwitchCompat;->O:Landroid/content/res/ColorStateList;
    ...
    iput-object v1, v0, Lo/a;->a:Ljava/util/Locale;

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->R:Lo/a;

    goto :goto_a

    :cond_17
    iput-object v12, v7, Landroidx/appcompat/widget/SwitchCompat;->R:Lo/a;

    :goto_a
    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->v:Ljava/lang/CharSequence;

    invoke-direct {v7, v0}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->x:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v7}, Landroidx/appcompat/widget/T;-><init>(Landroid/widget/TextView;)V

    const v1, 0x7f040479

    invoke-virtual {v0, v9, v1}, Landroidx/appcompat/widget/T;->g(Landroid/util/AttributeSet;I)V
    ...
    iput v2, v7, Landroidx/appcompat/widget/SwitchCompat;->B:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    invoke-direct/range {p0 .. p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Landroidx/appcompat/widget/z;

    move-result-object v0

    invoke-virtual {v0, v9, v1}, Landroidx/appcompat/widget/z;->b(Landroid/util/AttributeSet;I)V
    ...
    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->G:I
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->c0:Ljava/lang/String;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->d0:Landroid/view/animation/PathInterpolator;
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/z;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Landroidx/appcompat/widget/z;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Landroidx/appcompat/widget/z;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Landroidx/appcompat/widget/z;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->R:Lo/a;

    iget-object v0, v0, Landroidx/appcompat/widget/z;->b:LZ2/d;

    iget-object v0, v0, LZ2/d;->i:Ljava/lang/Object;

    check-cast v0, Lc0/g;

    invoke-virtual {v0, v1}, Lc0/g;->N(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final c(Z)Z
    ...
    invoke-static {p0}, Lb4/h;->A(Landroid/view/View;)Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Landroidx/appcompat/widget/g0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Landroidx/appcompat/widget/g0;->a:Landroid/graphics/Rect;
    ...
    iget v8, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:I
...
.method public final e()V
    ...
    invoke-virtual {v1, p0, v0}, LV/D;->h(Landroid/view/View;Ljava/lang/Object;)V
...
.method public final g()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->U:Landroidx/appcompat/widget/h1;
    ...
    invoke-direct {v1, p0}, Landroidx/appcompat/widget/h1;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->U:Landroidx/appcompat/widget/h1;
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->S:Landroidx/appcompat/widget/i1;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->S:Landroidx/appcompat/widget/i1;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object p0, Landroidx/appcompat/widget/SwitchCompat;->f0:[I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/g0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->F:F
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/text/TextPaint;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/g0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p5, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_9
    iput v7, p0, Landroidx/appcompat/widget/SwitchCompat;->A:I
...
.method public setChecked(Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->S:Landroidx/appcompat/widget/i1;
    ...
    :cond_3
    invoke-direct {v0, p0, v1, v2}, Landroidx/appcompat/widget/i1;-><init>(Landroidx/appcompat/widget/SwitchCompat;FF)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->d0:Landroid/view/animation/PathInterpolator;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->S:Landroidx/appcompat/widget/i1;
...
.method public setTrackDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;
