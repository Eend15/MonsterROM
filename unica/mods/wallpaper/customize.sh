...
if grep -q -F "video_001.mp4" "$APKTOOL_DIR/system/priv-app/wallpaper-res/wallpaper-res.apk/res/raw/resources_info.json"; then
    ...
    LOG "- Skipping 60fps wallpaper metadata patch: no video wallpaper metadata found"
fi
